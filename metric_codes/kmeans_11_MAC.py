...
kmeans = KMeans(n_clusters=10, random_state=0, n_init=1).fit(val_label)
...
# np.save('center_list_11.npy',center_list)

labels = []
meta_list = [[] for i in range(11)]
...
def check_correct(pred_traj_list):
    correct_list = [0 for i in range(11)]
    cnt = 0
